...
<?php $this->beginPage(); ?>
    ...
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        <div class="c-sidebar-brand d-lg-down-none">
            <svg class="c-sidebar-brand-full" width="118" height="46" alt="Muse Logo">
                <use xlink:href="<?= Yii::$app->assetManager->getPublishedUrl('@admin/web'); ?>/svg/coreui.svg#full_muse"></use>
            </svg>
            <svg class="c-sidebar-brand-minimized" width="46" height="46" alt="Muse Logo">
                <use xlink:href="<?= Yii::$app->assetManager->getPublishedUrl('@admin/web'); ?>/svg/coreui.svg#signed_muse"></use>
            </svg>
        </div>
                       ...
                       aria-expanded="false">
                        <div class="c-avatar">
                            <img class="c-avatar-img"
                                 src="/<?= Yii::$app->user->getIdentity()->getUserAR()->profile->image->src; ?>"
            ...
            <main class="c-main">
                <div class="container-fluid">
                    ...
                    <div style="display:none;">
                        <button id="show_modal_info" type="button" data-toggle="modal" data-target="#info_win"></button>
                    </div>
                </div>
            </main>
