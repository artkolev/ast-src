<?php
/**
 * @modelDescr Страница-каталог пользователей сайта (модуль users) с ролями Экспертный совет, Эксперт, Экспертная организация на кафедре
 */
...
class AllCatalog extends Page
{
    /* единый view для всех 3-х каталогов */
    public static $name_for_list = "Весь каталог";
    public static $count_for_list = 1;
    public $view = 'expert_catalog';
    public $action_id = 'pages/pages/all';
    public $content_seo;
