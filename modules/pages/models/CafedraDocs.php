<?php
/**
 * @modelDescr Страница Личного Кабинета - Требования кафедры в ЛК (содержит Файл с требованиями Основной кафедры пользователя и загруженные файлы для этой страницы)
 */
...
class CafedraDocs extends Page
{
    public static $name_for_list = "Требования кафедры в ЛК";
    public static $count_for_list = 1;
    public $view = 'documents_cafedra';
    public $accessLevel = 'restricted';
    public $action_id = 'pages/documents/documentscaf';
    public $docs_loader;
    ...
    {
        return $this->hasMany(FilestoreModel::class, ['keeper_id' => 'id'])->andWhere(['keeper_class' => CafedraDocs::class, 'keeper_field' => 'docs'])->orderBy(['order' => SORT_ASC]);
    }
}
