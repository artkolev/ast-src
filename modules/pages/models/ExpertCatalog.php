<?php
/**
 * @modelDescr Страница-каталог пользователей сайта (модуль users) с ролью Эксперт на кафедре
 */
...
class ExpertCatalog extends Page
{
    /* единый view для всех 3-х каталогов */
    public static $name_for_list = "Каталог экспертов";
    public static $count_for_list = 1;
    public static $accepted_roles = ['expert'];
    public $view = 'expert_catalog';
    public $action_id = 'pages/pages/expert';
