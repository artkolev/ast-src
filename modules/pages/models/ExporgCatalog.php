<?php
/**
 * @modelDescr Страница-каталог пользователей сайта (модуль users) с ролью Экспертная организация на кафедре
 */
...
class ExporgCatalog extends Page
{
    /* единый view для всех 3-х каталогов */
    public static $name_for_list = "Каталог экспертных организаций";
    public static $count_for_list = 1;
    public static $accepted_roles = ['exporg'];
    public $view = 'expert_catalog';
    public $action_id = 'pages/pages/exporg';
