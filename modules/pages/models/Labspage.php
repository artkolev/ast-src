<?php
/**
 * @modelDescr Страница-каталог лабораторий
 */

namespace app\modules\pages\models;

class Labspage extends Page
{
    public static $name_for_list = "Каталог лабораторий";
    public static $count_for_list = 1;
    public $view = 'labs';
    public $action_id = 'pages/pages/labs';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['start_module'], 'default', 'value' => 'labs'],
        ]);
    }
