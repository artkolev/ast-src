<?php
/**
 * @modelDescr Страница Личного Кабинета - Страница первого шага подачи заявки на присоединение к Маркетплейс для ИП. Содержит форму для заполнения данных об организации
 */
...
class PServiceRegIP extends Page
{
    public static $name_for_list = "Форма регистрации услуг как ИП";
    public static $count_for_list = 1;
    public $accessLevel = 'restricted';
    public $view = 'service_regform_ip';
    public $action_id = 'pages/service/regformip';
    ...
    {
        return $this->hasOne(FilestoreModel::class, ['keeper_id' => 'id'])->andWhere(['keeper_class' => PServiceRegIP::class, 'keeper_field' => 'primer']);
    }
}
