<?php
/**
 * @modelDescr Страница Личного Кабинета - Страница первого шага подачи заявки на присоединение к Маркетплейс для Самозанятого. Содержит форму для заполнения данных об организации
 */
...
class PServiceRegSelfbusy extends Page
{
    public static $name_for_list = "Форма регистрации услуг как Самозанятый";
    public static $count_for_list = 1;
    public $accessLevel = 'restricted';
    public $view = 'service_regform_selfbusy';
    public $action_id = 'pages/service/regformselfbusy';
    ...
    {
        return $this->hasOne(FilestoreModel::class, ['keeper_id' => 'id'])->andWhere(['keeper_class' => PServiceRegSelfbusy::class, 'keeper_field' => 'primer']);
    }
}
