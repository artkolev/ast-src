<?php
/**
 * @modelDescr Текстовая страница сайта с возможностью размещения виджета платежной системы (js-code)
 */
...
{
    public static $name_for_list = "страницу с виджетом Оплаты";
    public $view = 'payment';
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            'widget_code' => 'Адрес скрипта для подключения на странице',
        ]);
    }
