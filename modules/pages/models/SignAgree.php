<?php
/**
 * @modelDescr Страница Личного Кабинета - Страница содержит перечень соглашений (formagree), с которыми пользователь Личного кабинета должен согласиться для доступа к Личному кабинету
 */
...
class SignAgree extends Page
{
    public static $name_for_list = "страницу Подписания соглашений";
    public static $count_for_list = 1;
    public $accessLevel = 'none';
    public $view = 'sign_agree';
    public $action_id = 'pages/isle/agreements';
    public $expert_text;
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            'expert_text' => 'Приветствие для эксперта',
        ]);
    }
