...
use app\modules\pages\models\LKMaterialEdit;
use yii\helpers\Url;
...
foreach ($items as $material) {
    $statuses[$material->isTimeToPublish()]++;
}

$view_page = LKMaterialEdit::find()->where(['model' => LKMaterialEdit::class, 'visible' => 1])->one();
    ...
    <div class="container wide lk-container">
        <div class="lk_maincol">
                ...
                <?php foreach ($items as $item) {
                    ...
                    <div class="lk_order_item">
                        ...
                        <div class="lk_order_item_info">
                            <div>
                                <p>
                                    <span class="tgray">Дата создания материала:</span> <?= Yii::$app->formatter->asDatetime($item->created_at, 'dd.MM.y'); ?>
                                </p>
                            </div>
                            <div>
                                <p><?= $item->name; ?></p>
            ...
            <?php } else { ?>
                <div class="lk_block">
                    <main class="lk_content">
                        У вас нет созданных материалов в базе знаний.
                    </main>
                </div>
            <?php } ?>
        </div>
