...
use app\modules\pages\models\LKProjectEdit;
use yii\helpers\Url;
...
foreach ($items as $project) {
    $statuses[$project->isTimeToPublish()]++;
}

$view_page = LKProjectEdit::find()->where(['model' => LKProjectEdit::class, 'visible' => 1])->one();
                ...
                <?php foreach ($items as $item) {
                    ...
                    <div class="lk_order_item">
                        ...
                        <div class="lk_order_item_info">
                            <div>
                                <p>
                                    <span class="tgray">Дата создания проекта:</span> <?= Yii::$app->formatter->asDatetime($item->created_at, 'dd.MM.y'); ?>
                                </p>
                            </div>
                            <div>
                                <p><?= $item->name; ?></p>
