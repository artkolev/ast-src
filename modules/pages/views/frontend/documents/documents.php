                ...
                <main class="lk_content">
                    ...
                    if (!empty($contracts)) {
                        foreach ($contracts as $contract) { ?>
                            <a href="<?= $contract->getPdfLink(); ?>" class="link_file"><?= $contract->name; ?></a> <br>
                        <?php }
                    }
                    if (!empty($user->profile->contract)) {
                        foreach ($user->profile->contract as $key => $file) { ?>
                            <a href="<?= $user->profile->getFile('contract', $key); ?>"
