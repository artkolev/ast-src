...
?>
            ...
            <div class="lk_maincol">
                ...
                <div class="lk_block">
                    <main class="lk_content">
                        ...
                        <h4 class="lk_step_title font20 mt20">Укажите причину отмены программы</h4>
                        <?= $form->field($cancel_model, 'cancel_reason', ['options' => ['class' => 'ip_cell w100 mb50']])->textInput(); ?>

                        <h4 class="lk_step_title">Ознакомьтесь с текстом письма-уведомления об отмене программы</h4>
                        ...
                        <div class="ip_cell w100 flex justify-between buttons-wrapper mb0">
                            <button type="submit" class="button blue medium lk">Отменить программу и отправить
                                рассылку
                            </button>
                        </div>
                        <?php ActiveForm::end(); ?>
    ...
    <div class="modal" id="cancel_event_modal">
        <div class="modal_content">
            ...
            <div class="success_box">
                <div class="modal_title">Отмена программы</div>
                <p>Программа отменена. Рассылка уведомлений слушателям будет отправлена в ближайшее время.</p>
    ...
    <div class="modal" id="fail_event_modal">
        <div class="modal_content">
            <a href="#" class="modal_close">x</a>
            <div class="success_box">
                <div class="modal_title">Ошибка при отмене программы</div>
...
<?php
$url = Url::toRoute(['/pages/eduprog/sendcancelform']);
$js = <<<JS
    $('#eduprog-cancel').on('beforeSubmit', function(event){
        var formData = new FormData($('#eduprog-cancel')[0]);
        $.ajax({
            type: 'POST',
            url: '{$url}',
            contentType: false,
    ...
    $('#eduprog-cancel').on('submit', function(e){
        e.preventDefault();
        return false;
    });
JS;
