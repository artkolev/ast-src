        ...
        <div class="lk_maincol">
            ...
            <div class="lk_block">
                <main class="lk_content lk_content_expert-service-card_basic">
                    <p>Эксперт:</p>
                    <h4 class="blue"><a
                                href="<?= $order->executor->getUrlPath(); ?>"><?= $order->executor->profile->halfname; ?></a>
                    </h4>
                    <p>Услуга:</p>
                            ...
                            <div class="tabs-content">
                                <div class="tab-item <?= ($role == 'urusr' || $role == 'exporg') ? '' : 'active'; ?>"
                                    ...
                                    <form>
                                        ...
                                        <div class="ip_cell w100">
                                            ...
                                            <input type="text" class="input_text phone-mask js-payment-phone"
                                                   placeholder="" value="<?= $user->profile->phone; ?>">
                                        </div>
                                        <div class="ip_cell w100">
                                        ...
                                        <div class="ip_cell w100 mb0">
                                            <button class="button blue big w100 js-payment-card-save disabled">
                                                Продолжить
                                            </button>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-item <?= ($role == 'urusr' || $role == 'exporg') ? 'active' : ''; ?>"
                                    ...
                                    <form>
                                        ...
                                        <div class="ip_cell w100 mb0">
                                            <button class="button blue big w100 js-payment-schet-save disabled">
                                                Продолжить
                                            </button>
                                        </div>
                                    </form>
