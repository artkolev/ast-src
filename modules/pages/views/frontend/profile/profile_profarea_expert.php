                ...
                <div class="lk_block">
                    ...
                    <main class="lk_content">
                        ...
                        <div class="ip_cell w100 ">
                            ...
                            <h4 class="ip_cell mb0">Кафедра "<?= $modelform->getMainDirectionName(); ?>"</h4>
                        </div>
                        <?= ''; // =$form->field($modelform, 'direction')->dropDownList($modelform->getDirectionList(),['class' => "pretty_select_max3",'multiple'=>'multiple']); ?>
                        <?= $form->field($modelform, 'keywords')->widget(KeywordWidget::class)->label(''); ?>
                        <?= $form->field($modelform, 'competence')->dropDownList($modelform->getCompetenceList(), ['class' => "pretty_tags_ns", 'multiple' => 'multiple']); ?>
                        <?= $form->field($modelform, 'solvtask')->dropDownList($modelform->getSolvtaskList(), ['class' => "pretty_tags_ns", 'multiple' => 'multiple']); ?>
                        <div class="ip_cell w100">
...
<?php
$url = Url::toRoute(['/pages/profile/saveprofarea']);
$js = <<<JS
