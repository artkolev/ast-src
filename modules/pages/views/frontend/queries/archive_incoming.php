<?php
/*
    @descr Архив запросов (Запросы эксперта, ЛК)

    @var $model Class app\modules\pages\models\QueriesIncomingArchive; текущая страница
    ...
    @action pages/queries/archiveincoming
*/
