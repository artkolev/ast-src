            ...
            <div class="lk_maincol">
                ...
                <div class="lk_block">
                    <main class="lk_content lk_content-basic">
                        ...
                        <?php } ?>
                        <p>Предложенные условия:</p>
                        <h4>Срок: <?= Yii::$app->formatter->asDatetime($query->offered_datestart, 'd.MM.y'); ?>
                        ...
                        <a href="#" class="button lk open_slidebox" data-slide_box="setprice">Изменить условия</a>
                    </main>
                </div>
                ...
                $modelform->query_id = $query->id;
                $modelform->price = (int)$query->offered_price;
                $modelform->date_start = Yii::$app->formatter->asDatetime($query->offered_datestart, 'd.MM.y');
                $modelform->date_end = Yii::$app->formatter->asDatetime($query->offered_dateend, 'd.MM.y');
                $modelform->special = $query->special;
                ?>
                <div id="setprice" class="lk_block lk_block-change-service_basic slide_box hidden">
                    ...
                    <header class="lk_block_header">
                        <?= $form->field($modelform, 'price')->input('number', ['class' => 'input_text ip_medium end w206px input_change-service_blue onlyNumber', 'placeholder' => 'Введите сумму']); ?>
                    </header>
