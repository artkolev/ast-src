        ...
        <div class="lk_maincol">
            ...
            <div class="lk_block">
                <main class="lk_content lk_content-basic">
                    ...
                    <a href="#" class="button lk reflect_status" data-query="<?= $query->id; ?>">Принять условия и
                        оплатить</a>
                </main>
            </div>
...
$url_query_done = Url::toRoute(['/pages/queries/finalize']);
$js = <<<JS
