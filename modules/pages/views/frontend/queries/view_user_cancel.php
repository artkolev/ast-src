...
switch ($query->status) {
    case Queries::STATUS_EXECCANCEL:
        $initiator = 'Исполнитель';
        $reason = $query->reject_reason_executor;
        break;
    case Queries::STATUS_USERCANCEL:
        $initiator = 'Клиент';
        $reason = $query->reject_reason_user;
        break;
} ?>
        ...
        <div class="lk_maincol">
            ...
            <div class="lk_order_item">
                <div class="lk_order_item_info-basic">
                    ...
                    <div class="grid-template-b">
                        <div><h4>Статус:</h4>
                            <p class="yellow"><?= $query->statusName; ?></p></div>
                        <div><h4>Эксперт:</h4>
            ...
            <div class="lk_block">
                <main class="lk_content lk_content-basic">
                    ...
                    <p><?= $initiator; ?> отклонил запрос.</p>
                    <?php if (!empty($reason)) { ?>
                        <h4>Причина отказа: <br> <?= $reason; ?></h4>
                    <?php } ?>
