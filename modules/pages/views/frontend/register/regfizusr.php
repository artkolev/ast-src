...
$url = Url::toRoute(['/pages/register/savefizusr']);
$js = <<<JS
    $('#regfizusr-form').on('beforeSubmit', function(event){
        $('#regfizusr-form .js-submit-button').prop('disabled', true);
            var formData = new FormData($('#regfizusr-form')[0]);
            $.ajax({
                type: 'POST',
                url: '{$url}',
                contentType: false,
                ...
                success: function(data) {
                    ...
                    $('#regfizusr-form .js-submit-button').prop('disabled', false);
                    }
    ...
    $('#regfizusr-form').on('submit', function(e){
    	e.preventDefault();
    	return false;
    });

    $('#regfizusr-form').on('beforeValidate', function(event){
        $('#regfizusr-form .js-submit-button').prop('disabled', true);
    });

    $('#regfizusr-form').on('afterValidate', function(event, messages, errorAttributes){
