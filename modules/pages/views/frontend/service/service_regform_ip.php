            ...
            <div class="lk_maincol">
                <div class="lk_block">
                    ...
                    <main class="lk_content">
                        ...
                        <?= $form->field($modelform, 'email')->input('email', ['placeholder' => "E-mail"]); ?>
                        <?= $form->field($modelform, 'phone')->input('tel', ['placeholder' => "Телефон", 'class' => 'input_text phone-mask']); ?>

                        <?= $form->field($modelform, 'inn')->textInput(['class' => "input_text inn-mask"]); ?>
                        ...
                        <div class="mb20 pdf_container">
                            <label class="ip_label" for="regservice-docs">
                                Загрузите соглашение об аналоге собственноручной подписи. <br>
                                Если Вы не являетесь лично ИП, а представляете интересы другого ИП, то Вам необходимо
                                получить заверенное подписью индивидуального предпринимателя Соглашение об аналоге
                                собственноручной подписи. <?php if (!empty($model->primer)) { ?><a
                                    href="<?= $model->getFile('primer'); ?>">Ссылка на скачивание.</a><?php } ?> <br>
                            </label>
                            <br>
                        ...
                        <?= ''; // =$form->field($modelform, 'comment',['template'=>'{label}{input}<span class="symbols_counter">500 символов</span>{error}{hint}','options'=>['class'=>'ip_cell w100 symbols_counter_box']])->textArea(['placeholder'=>'Укажите особую информацию','class'=>"input_text limitedSybmbols",'maxlength'=>500]); ?>
    ...
    <div class="modal" id="fail_service_modal">
        <div class="modal_content">
            ...
            <div class="success_box">
                <div class="modal_title">Ошибка регистрации ИП</div>
...
<?php
$url = Url::toRoute(['/pages/service/saveip']);
