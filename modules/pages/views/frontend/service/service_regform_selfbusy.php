            ...
            <div class="lk_maincol">
                <div class="lk_block">
                    ...
                    <main class="lk_content">
                        ...
                        <p>Почтовый адрес</p>
                        <?= $form->field($modelform, 'match_post', ['template' => '{input}<label>Совпадает с адресом регистрации</label>{hint}{error}', 'options' => ['class' => 'ip_cell']])->checkbox(['class' => 'ch mailing-ch'], false); ?>
                        ...
                        <div class="mail-addr" style="display: none;">
                        ...
                        <?= $form->field($modelform, 'raschet_account')->textInput(['class' => "input_text rs-mask"])->label('Номер счета'); ?>
    ...
    <div class="modal" id="fail_service_modal">
        <div class="modal_content">
            ...
            <div class="success_box">
                <div class="modal_title">Ошибка регистрации Самозанятого</div>
...
<?php
$url = Url::toRoute(['/pages/service/saveselfbusy']);
